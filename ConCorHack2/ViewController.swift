...
//  ConCorHack2
//
//  Created by Alexander Malyshev on 05/07/2017.
//  Copyright © 2017 Malyshev Alexander. All rights reserved.
//
...
class ChartsViewController: UIViewController {
    ...
    class DirSelector: UIView {
        ...
        weak var controller: ChartsViewController?
        
        fileprivate let buttonDirs: [UIButton : Bool]
        
        init(frame: CGRect, controller: ChartsViewController) {
